...
node('linux') {
    stage("Test Stack") {
       ...
       sh 'aws cloudformation create-stack --stack-name final-test --template-body file://docker-single-server.json --parameters ParameterKey=KeyPairName,ParameterValue=Finals' 
       sh 'curl ifconfig.me'
