...
sh 'aws cloudformation stack-create-complete --stack-name final-test2 --template-body file://docker-single-server.json --region=us-east-1 --parameters ParameterKey=YourIp,ParameterValue=52.205.197.43/32'
