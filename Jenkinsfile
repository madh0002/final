...
node('linux') {
    stage("Test Stack") {
       ...
       sh 'aws cloudformation create-stack --stack-name final-test --template-body file://docker-single-server.json --region=us-east-1 --parameters YourIp=\' curl ifconfig.me/ip\'' 
