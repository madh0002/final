...
node('linux') {
    stage("Test Stack") {
       ...
       //sh 'aws cloudformation create-stack --stack-name final-test1 --template-body file://docker-single-server.json --region=us-east-1 --parameters ParameterKey=YourIp,ParameterValue=\' curl ifconfig.me/ip\'' 
